                                    ...
                                    <div class="col-md-12">
                                        <div data-height="200" class="products nav-slider">
                                            ...
                                            <div class="item product-01">
                                                ...
                                                <div class="item-right"><span class="price woocommerce-Price-amount amount"><?php echo e($f->price); ?> <span class="price-symbol">vnd</span></span></div>
                                            </div>
            ...
            <section class="product-sesction-02 padding-top-100 padding-bottom-100">
                <div class="container">
                    ...
                    <div class="swin-sc swin-sc-product products-02 carousel-02 product-paging">
                        ...
                        <?php echo $__env->make('Pagination.ajax-paging-index', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
