                                ...
                                <div class="row">
                                    <div class="nav-slider">
                                        <div class="tab-content">
                                            <div class="col-md-5 col-sm-12">
                                                <div class="cat-wrapper">
                                                    <div class="item"><img src="<?php echo e(URL::asset("images/product/pd-cat-dessert.png")); ?>" alt="" class="img img-responsive img-full"></div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="tab-content">
                                            <div class="col-md-5 col-sm-12">
                                                <div class="cat-wrapper">
                                                    <div class="item"><img src="<?php echo e(URL::asset("images/product/pd-cat-lunch.png")); ?>" alt="" class="img img-responsive img-full"></div>
                                                </div>
                                            </div>
                                            <div class="col-md-7 col-sm-12">
                                                <div class="products">
                                        ...
                                        <div class="tab-content">
                                            <div class="col-md-5 col-sm-12">
                                                <div class="cat-wrapper">
                                                    <div class="item"><img src="<?php echo e(URL::asset("images/product/pd-cat-dinner.png")); ?>" alt="" class="img img-responsive img-full"></div>
                                                </div>
                                            </div>
                                            <div class="col-md-7 col-sm-12">
                                                <div class="products">
                                    ...
                                    <div class="item-slick">
                                        <div class="row">
                                            <div class="col-md-2 col-sm-4 col-xs-12">
                                                <div class="item product-01">
                                                    <div class="block-img"><img src="<?php echo e(URL::asset("images/product/product-01.jpg")); ?>" alt="">
                                            ...
                                            <div class="col-md-2 col-sm-4 col-xs-12">
                                                <div class="item product-01">
                                                    <div class="block-img"><img src="<?php echo e(URL::asset("images/product/product-01b.jpg")); ?>" alt="">
                                                        <div class="group-btn"><a href="#" class="swin-btn btn-link"><i class="icons fa fa-link"></i></a><a href="#" class="swin-btn btn-add-to-card"><i class="fa fa-shopping-basket"></i></a></div>
                                                    </div>
                                            ...
                                            <div class="col-md-2 col-sm-4 col-xs-12">
                                                <div class="item product-01">
                                                    <div class="block-img"><img src="<?php echo e(URL::asset("images/product/product-01c.jpg")); ?>" alt="">
                                                        <div class="group-btn"><a href="#" class="swin-btn btn-link"><i class="icons fa fa-link"></i></a><a href="#" class="swin-btn btn-add-to-card"><i class="fa fa-shopping-basket"></i></a></div>
                                                    </div>
                                            ...
                                            <div class="col-md-2 col-sm-4 col-xs-12">
                                                <div class="item product-01">
                                                    <div class="block-img"><img src="<?php echo e(URL::asset("images/product/product-01d.jpg")); ?>" alt="">
                                                        <div class="group-btn"><a href="#" class="swin-btn btn-link"><i class="icons fa fa-link"></i></a><a href="#" class="swin-btn btn-add-to-card"><i class="fa fa-shopping-basket"></i></a></div>
                                                    </div>
                                            ...
                                            <div class="col-md-2 col-sm-4 col-xs-12">
                                                <div class="item product-01">
                                                    <div class="block-img"><img src="<?php echo e(URL::asset("images/product/product-01e.jpg")); ?>" alt="">
                                                        <div class="group-btn"><a href="#" class="swin-btn btn-link"><i class="icons fa fa-link"></i></a><a href="#" class="swin-btn btn-add-to-card"><i class="fa fa-shopping-basket"></i></a></div>
                                                    </div>
                                                    <a href="ds-thuc-don.html"><h5 class="title">Frish Cheese Chip</h5><span class="price woocommerce-Price-amount amount"><span class="price-symbol">$</span>25.0</span></a>
                                                </div>
                                            ...
                                            <div class="col-md-2 col-sm-4 col-xs-12">
                                                <div class="item product-01">
                                                    <div class="block-img"><img src="<?php echo e(URL::asset("images/product/product-01f.jpg")); ?>" alt="">
                                                        <div class="group-btn"><a href="#" class="swin-btn btn-link"><i class="icons fa fa-link"></i></a><a href="#" class="swin-btn btn-add-to-card"><i class="fa fa-shopping-basket"></i></a></div>
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-2 col-sm-4 col-xs-12">
                                                <div class="item product-01">
                                                    <div class="block-img"><img src="<?php echo e(URL::asset("images/product/product-01l.jpg")); ?>" alt="">
                                                        <div class="group-btn"><a href="#" class="swin-btn btn-link"><i class="icons fa fa-link"></i></a><a href="#" class="swin-btn btn-add-to-card"><i class="fa fa-shopping-basket"></i></a></div>
                                                    </div>
